...
const Show: FunctionComponent<IShowProps> = ({ showType, year }) => {
  ...
  return (
    <Container maxWidth="md" className="main-content" sx={{
      ...
      <IconButton sx={{display: drawerOpen ? 'none' : 'inline-flex', position: 'absolute', bottom: '20px', right: '20px', zIndex: '9999', backgroundColor: 'white', height: '50px', width: '50px'}} onClick={toggleDrawer(true)}>
        <SortRoundedIcon  />
      </IconButton>
